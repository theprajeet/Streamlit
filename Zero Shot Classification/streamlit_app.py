...
App created by [Team BIET] using [Streamlit](https://streamlit.io/)🎈 and [HuggingFace](https://huggingface.co/inference-api)'s [Distilbart-mnli-12-3](https://huggingface.co/valhalla/distilbart-mnli-12-3) model.
...
with MainTab:
    ...
    with st.form(key="my_form"):
        ...
        labels_from_st_tags = st_tags(
            value=["Postive", "Negative", "Neutral"],
            maxtags=6,
        ...
        # for item in dataframe["Texts"]:
        #     pre_defined_keyphrases.append(item)
        pre_defined_keyphrases = pre_defined_keyphrases + csv_data
    ...
    if not submit_button and not st.session_state.valid_inputs_received:
        ...
        with cs:
            ...
            count_data = df.groupby('label').size().reset_index(name='Count')
